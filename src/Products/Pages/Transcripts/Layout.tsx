...
const DropdownContainer: React.FC<DropdownContainerProps> = () => {
    ...
    const [selectedOption, setSelectedOption] = useState<string | null>(storedSelectedOption);
    ...
    const toggleDropdown = () => {
        ...
        localStorage.removeItem('selectedOption'); // Remove from local storage
    };

    useEffect(() => {
        // Clear selectedOption from local storage on component unmount
        return () => {
                                ...
                                {selectedOption === 'option3' && (
                                 ...
                                 {selectedOption === 'option6' && (
                                    <div className="container w-[80%] pl-[2%] pt-[2%]">
                                        ...
                                        <div className='container w-[100%] pl-[2%] pt-[2%]'>
                                            <div className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select your Mp4 File</div>
                                            <input className="block w-full mb-5 text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-00 dark:border-gray-600 dark:placeholder-gray-400" id="default_size" type="link" />
