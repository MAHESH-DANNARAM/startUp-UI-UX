    ...
    <>
      {/* <div className="sidebar-wrapper active">
          ...
          <div className="d-flex justify-content-between align-items-center">
            ...
            <div className="theme-toggle d-flex gap-2  align-items-center mt-2">
              ...
              <div className="form-check form-switch fs-6">
                <input
                  className=" cursor-pointer  form-check-input  me-0"
                  type="checkbox"
                  id="toggle-dark"
                />
        ...
        <div className="sidebar-menu">
          <ul className="menu">
            <li className="sidebar-title">idebarItem</li>
            <li className="sidebar-item {{ 'active' if (sidebarItem.url == filename or filename|startsWith(sidebarItem.key)) }} {{'has-sub' if sidebarItem.submenu.length > 0 }}">
              ...
              >
                <i className="bi bi-{{ sidebarItem.icon }}"></i>
                <span>idebarItame</span>
              </a>
          ...
          <span>Menu</span>
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ml-3 whitespace-nowrap">Text to Video</span>
            ...
            <li>
              <a
                ...
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <span className="flex-1 ml-3 whitespace-nowrap">Text to Voice with Voice Clone</span>
            ...
            <li>
              <a
                ...
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <span className="flex-1 ml-3 whitespace-nowrap">Text to 3D Objects</span>
            ...
            <li>
              <a
                ...
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <span className="flex-1 ml-3 whitespace-nowrap">Text to charts</span>
            ...
            <li>
              <a
                ...
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <span className="flex-1 ml-3 whitespace-nowrap">Text to Music</span>
            ...
            <li>
              <a
                ...
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <span className="flex-1 ml-3 whitespace-nowrap">Transcripts</span>
            ...
            <li>
              <a
                ...
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <span className="flex-1 ml-3 whitespace-nowrap">Video Generation using 3D Avatar</span>
