      ...
      <div id="component-2" className="svelte-10ogue4 pl-96 pr-12 ">
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <div
                  ...
                  className="gr-block gr-box relative w-full border-solid border-gray-200 !p-0 !m-0 !border-0 !shadow-none !overflow-visible !bg-transparent gr-padded"
                >
                ...
                <div
                  ...
                  className="gr-block gr-box relative w-full overflow-hidden border-solid border border-gray-200 !p-0 !m-0 !shadow-none !bg-transparent gr-padded"
                >
                  <label className="block w-full">
                    <span className="text-gray-500 text-[0.855rem] mb-2 block dark:text-gray-200 relative z-40 sr-only h-0 !m-0">
            ...
            <button
            type="button"
              className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"              id="component-9"
            >
              Generate image
            </button>
          </div>
